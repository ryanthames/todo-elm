...
type alias Todo = {title: String, completed: Bool, editing: Bool}

type FilterState = All | Active | Completed

type alias Model = {todos: List Todo, todo: Todo, filter: FilterState}
...
view model =
  ...
  [
    ...
    [
      ...
      section [class "main"]
      [
        ul [class "todo-list"] (List.map todoView model.todos)
      ]
    ]
  ]
